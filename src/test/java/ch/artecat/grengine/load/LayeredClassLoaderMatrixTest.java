...
import static ch.artecat.grengine.load.LayeredClassLoaderMatrixTest.CodeLayersType.CODE_LAYERS_CURRENT_FIRST;
import static ch.artecat.grengine.load.LayeredClassLoaderMatrixTest.CodeLayersType.CODE_LAYERS_PARENT_FIRST;
import static ch.artecat.grengine.load.LayeredClassLoaderMatrixTest.ParentClassLoaderType.PARENT_IS_REGULAR_CLASS_LOADER;
import static ch.artecat.grengine.load.LayeredClassLoaderMatrixTest.ParentClassLoaderType.PARENT_IS_SOURCE_CLASS_LOADER;
import static ch.artecat.grengine.load.LayeredClassLoaderMatrixTest.SourcesChangedState.SOURCES_CHANGED;
import static ch.artecat.grengine.load.LayeredClassLoaderMatrixTest.SourcesChangedState.SOURCES_UNCHANGED;
import static ch.artecat.grengine.load.LayeredClassLoaderMatrixTest.TopCodeCacheType.TOP_CODE_CACHE_CURRENT_FIRST;
import static ch.artecat.grengine.load.LayeredClassLoaderMatrixTest.TopCodeCacheType.TOP_CODE_CACHE_OFF;
import static ch.artecat.grengine.load.LayeredClassLoaderMatrixTest.TopCodeCacheType.TOP_CODE_CACHE_PARENT_FIRST;
